...
class RestClient1PutTest extends RestClient1AbstractTest {
    ...
    void shouldWithBodyExecuteCorrectlyWhenResponse200() {
        ...
        RestClient1 client = clientWith(PUT, BASE_URL, PATH, EVALUATE_PAYLOAD_BODY);
    ...
    void shouldWithEmptyBodyExecuteCorrectlyWhenResponse200() {
        ...
        RestClient1 client = clientWith(PUT, BASE_URL, PATH);
    ...
    void shouldThrowExceptionWhenResponseNot2xx() {
        ...
        RestClient1 component = clientWith(PUT, BASE_URL, PATH);
