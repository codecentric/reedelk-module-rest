...
class HttpPredicateODataTest {
    ...
    private void assertThatMatchesWithConditions(String uriPattern, String uri, BiConsumer<Map<String, String>, Map<String, List<String>>> queryAndPathParamsConsumer) {
        ...
        HttpPredicate.MatcherResult matches = predicate.matches(request.method(), request.uri());
        assertThat(matches).isIn(HttpPredicate.MatcherResult.EXACT_MATCH, HttpPredicate.MatcherResult.TEMPLATE_MATCH);
