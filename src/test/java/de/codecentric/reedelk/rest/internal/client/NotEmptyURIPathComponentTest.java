...
import de.codecentric.reedelk.rest.internal.client.uri.NotEmptyURIPathComponent;
import de.codecentric.reedelk.rest.internal.commons.MapUtils;
import org.junit.jupiter.api.Test;

import java.util.Map;

import static de.codecentric.reedelk.rest.internal.commons.MapUtils.newMap;
...
class NotEmptyURIPathComponentTest {
    ...
    void shouldCorrectlyReplaceOnlyUriParams() {
        ...
        Map<String,String> uriParams = MapUtils.newMap("uriParam1", "value1");
        Map<String,String> queryParams = MapUtils.newMap();
    ...
    void shouldCorrectlyAddOnlyQueryParams() {
        ...
        Map<String,String> uriParams = MapUtils.newMap();
        Map<String,String> queryParams = MapUtils.newMap(
                "query1","value1",
                "query2", "value2");
    ...
    void shouldReplaceWithEmptyStringWhenUriParamsMapIsNull() {
        ...
        Map<String,String> queryParams = MapUtils.newMap("query1","value1");
    ...
    void shouldEncodeQueryParamValueCorrectly() {
        ...
        Map<String,String> uriParams = MapUtils.newMap();
        Map<String,String> queryParams = MapUtils.newMap("query1", "+super fancy (@#$7 query param");
    ...
    void shouldEncodeQueryParamKeyCorrectly() {
        ...
        Map<String,String> uriParams = MapUtils.newMap();
        Map<String,String> queryParams = MapUtils.newMap("+super+fancy+$key", "value");
    ...
    void shouldOdata2() {
        ...
        Map<String,String> uriParams = MapUtils.newMap();
        Map<String,String> queryParams = MapUtils.newMap("$top", "2");
