...
class RESTListenerPostTest extends RESTListenerAbstractTest {
    ...
    void shouldReturn200() {
        ...
        RESTListener listener = listenerWith(RestMethod.POST, defaultConfiguration);
    ...
    void shouldPostMultipartData() throws IOException {
        ...
        assertExistsPartWith(parts, "myfile", APPLICATION_BINARY, binaryContent,
                ImmutableMap.of(
                        HttpHeader.CONTENT_TYPE, ContentType.APPLICATION_OCTET_STREAM.toString(),
                        HttpHeader.TRANSFER_ENCODING, "binary",
                        "filename", "file.ext"));
    }
    ...
    void shouldPutMultipartReturnInternalServerError() throws IOException {
        ...
        RESTListener listener = listenerWith(RestMethod.PUT, defaultConfiguration);
        listener.onStart();
        ...
        assertThat(responseAsString).contains(Messages.RestListener.ERROR_MULTIPART_NOT_SUPPORTED.format());
    }
