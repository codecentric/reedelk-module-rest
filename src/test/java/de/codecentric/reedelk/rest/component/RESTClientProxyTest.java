...
class RESTClientProxyTest extends RESTClientAbstractTest {
    ...
    void shouldThrowExceptionWhenProxyButNoConfigIsDefined() {
        ...
        assertThat(thrown).hasMessage("RESTClientConfiguration (de.codecentric.reedelk.rest.component.RESTClientConfiguration) has a configuration error: Proxy Configuration must be present in the JSON definition when 'proxy' property is 'PROXY'");
    }
