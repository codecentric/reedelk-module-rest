...
import static de.codecentric.reedelk.runtime.api.message.content.MimeType.*;
...
class RESTClientPostTest extends RESTClientAbstractTest {
    ...
    class PayloadAndContentTypeAreCorrect{
        ...
        void shouldSetCorrectContentTypeHeaderWhenPayloadIsJson() {
            ...
            RESTClient component = clientWith(RestMethod.POST, BASE_URL, PATH, EVALUATE_PAYLOAD_BODY);
            ...
            givenThat(post(urlEqualTo(PATH))
                    ...
                    .withHeader(HttpHeader.CONTENT_TYPE, equalTo(APPLICATION_JSON.toString()))
        ...
        void shouldSetCorrectContentTypeHeaderWhenPayloadIsText() {
            ...
            givenThat(post(urlEqualTo(PATH))
                    ...
                    .withHeader(HttpHeader.CONTENT_TYPE, equalTo(TEXT_PLAIN.toString()))
                    .willReturn(aResponse()
                            .withStatus(200)
                            .withBody(expectedResponseBody)
                            .withHeader(HttpHeader.CONTENT_TYPE, TEXT_PLAIN.toString())));
        ...
        void shouldSetCorrectContentTypeHeaderWhenPayloadIsBinary() {
            ...
            givenThat(post(urlEqualTo(PATH))
                    ...
                    .withHeader(HttpHeader.CONTENT_TYPE, equalTo(APPLICATION_BINARY.toString()))
                    .willReturn(aResponse()
                            .withStatus(200)
                            .withBody(expectedResponseBody)
                            .withHeader(HttpHeader.CONTENT_TYPE, TEXT_PLAIN.toString())));
        ...
        void shouldNotSetContentTypeHeaderWhenPayloadIsScript() {
            ...
            RESTClient component = clientWith(RestMethod.POST, BASE_URL, PATH, body);
            ...
            verify(newRequestPattern().withoutHeader(HttpHeader.CONTENT_TYPE));
        }
    ...
    void shouldPostThrowExceptionWhenResponseNot2xx() {
        ...
        RESTClient component = clientWith(RestMethod.POST, BASE_URL, PATH);
