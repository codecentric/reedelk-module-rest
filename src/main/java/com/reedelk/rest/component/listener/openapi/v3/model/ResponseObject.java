...
public class ResponseObject implements Implementor {
    ...
    public com.reedelk.runtime.openapi.v3.ResponseObject map(OpenApiSerializableContext context) {
        com.reedelk.runtime.openapi.v3.ResponseObject target =
                new com.reedelk.runtime.openapi.v3.ResponseObject();
        ...
        // Headers
        Map<String, com.reedelk.runtime.openapi.v3.HeaderObject> mappedHeaders = new HashMap<>();
