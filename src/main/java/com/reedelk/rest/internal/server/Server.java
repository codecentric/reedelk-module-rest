...
public interface Server {
    ...
    void addRoute(String path, RestMethod method, Response response, ErrorResponse errorResponse, OperationObject openApiObject, HttpRequestHandler httpHandler);
