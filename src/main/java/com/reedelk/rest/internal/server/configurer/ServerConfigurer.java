...
public class ServerConfigurer {
    ...
    public static void configure(ServerBootstrap bootstrap, RestListener1Configuration configuration) {
    ...
    public static Consumer<Connection> onConnection(RestListener1Configuration configuration) {
        return connection -> {
    ...
    public static HttpServer configure(HttpServer server, RestListener1Configuration configuration) {
