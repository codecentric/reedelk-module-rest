...
public abstract class AbstractOpenApiSerializable implements OpenApiSerializable {
    ...
    protected void set(JSONObject object,
                       String propertyName,
                       OpenApiSerializable serializable,
    ...
    protected void set(JSONObject object,
                       String propertyName,
                       List<? extends OpenApiSerializable> serializableList,
                       OpenApiSerializableContext context) {
    ...
    protected void set(JSONObject object,
                       String propertyName,
                       Map<String, ? extends OpenApiSerializable> serializableMap,
                       OpenApiSerializableContext context) {
