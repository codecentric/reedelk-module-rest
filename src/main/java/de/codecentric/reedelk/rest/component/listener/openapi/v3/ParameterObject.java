...
public class ParameterObject implements Implementor, OpenAPIModel<de.codecentric.reedelk.openapi.v3.model.ParameterObject> {
    ...
    @Override
    public de.codecentric.reedelk.openapi.v3.model.ParameterObject map(OpenApiSerializableContext context) {
        de.codecentric.reedelk.openapi.v3.model.ParameterObject mappedParameter =
                new de.codecentric.reedelk.openapi.v3.model.ParameterObject();
        mappedParameter.setName(name);
        mappedParameter.setDescription(description);
        if (in != null) {
            mappedParameter.setIn(de.codecentric.reedelk.openapi.v3.model.ParameterLocation.valueOf(in.name()));
        }
        if (style != null) {
            mappedParameter.setStyle(de.codecentric.reedelk.openapi.v3.model.ParameterStyle.valueOf(style.name()));
        }
