...
public class OAuthFlowsObject implements Implementor, OpenAPIModel<de.codecentric.reedelk.openapi.v3.model.OAuthFlowsObject> {
    ...
    @Override
    public de.codecentric.reedelk.openapi.v3.model.OAuthFlowsObject map(OpenApiSerializableContext context) {
        de.codecentric.reedelk.openapi.v3.model.OAuthFlowsObject mapped = new de.codecentric.reedelk.openapi.v3.model.OAuthFlowsObject();
