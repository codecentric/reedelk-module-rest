...
import de.codecentric.reedelk.rest.component.client.*;
    ...
    public synchronized HttpClient create(RESTClient listener, RESTClientConfiguration configuration) {
        ...
        if (Authentication.BASIC.equals(authentication)) {
            BasicAuthenticationConfiguration basicConfig =
                    requireNotNull(RESTClientConfiguration.class, configuration.getBasicAuthentication(), Messages.RestClient.BASIC_AUTH_MISSING.format());
        ...
        if (Authentication.DIGEST.equals(authentication)) {
            DigestAuthenticationConfiguration digestConfig =
                    requireNotNull(RESTClientConfiguration.class, configuration.getDigestAuthentication(), Messages.RestClient.DIGEST_AUTH_MISSING.format());
        ...
        if (Proxy.PROXY.equals(proxy)) {
            ProxyConfiguration proxyConfig =
                    requireNotNull(RESTClientConfiguration.class, configuration.getProxyConfiguration(), Messages.RestClient.PROXY_CONFIG_MISSING.format());
